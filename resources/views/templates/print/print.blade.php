        ...
        <div class="row">
            <div id="paper-top">
                <ul id="breadcrumb">
                    ...
                    <li><a href="javascript:void(0)" title="Sample page 1">打印</a>
                    </li>
            ...
            <div class="page-extra">
                <section class="content invoice">
                    ...
                    <div class="row">
                        <div class="col-xs-12 invoice-header">
                            <h2 class="page-header">
                                <i class="fa fa-globe"></i> 打印
                                <small class="pull-right">日期: 05/03/2017</small>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <p class="lead"><strong>付款</strong></p>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            ...
                            <button class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> 生成 PDF</button>
                        </div>
                    </div>
                </section>
                <!-- /.content -->
