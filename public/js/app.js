//BACKGROUND CHANGER
  $(function() {
      $("#button-bg").click(function() {
          $("body").css({
              "background": "url('img/bg5.jpg')repeat center center fixed"
          });
      });
      ...
      $("#button-bg8").click(function() {
          $("body").css({
              "background": "url('img/bg8.jpg')repeat center center fixed"
          });
      });
      $("#button-bg9").click(function() {
          $("body").css({
              "background": "url('img/bg9.jpg')repeat center center fixed"
          });
      });

      $("#button-bg10").click(function() {
          $("body").css({
              "background": "url('img/bg10.jpg')repeat center center fixed"
          });
      });
      $("#button-bg11").click(function() {
          $("body").css({
              "background": "url('img/bg11.jpg')repeat center center fixed"
          });
      });
      $("#button-bg12").click(function() {
          $("body").css({
              "background": "url('img/bg12.jpg')repeat center center fixed"
          });
      });
